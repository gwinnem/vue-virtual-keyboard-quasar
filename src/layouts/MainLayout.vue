...
<!--        </q-btn>-->
    ...
    >
      <q-scroll-area class="fit">
        ...
        <q-list padding>
          <q-item v-for="link in links1" :key="link.text" clickable class="GPL__drawer-item" :to="link.route">
												<q-item-section avatar>
    ...
    <q-page-container class="GPL__page-container">
      <router-view />
					<q-page-scroller>
						<q-btn fab-mini color="brand-primary" glossy icon="fa-solid fa-chevron-up"></q-btn>
					</q-page-scroller>
    </q-page-container>
  </q-layout>
</template>
